function loadLibrary() {
    5 != isMobile.any()
        ? (appendLibrary("static/loadLibraryForPC.js"),
          whenAvailable("loadLibraryForPC", function (i) {
              loadLibraryForPC();
          }))
        : whenAvailable("$", function (i) {
              appendLibrary("static/func.js"), appendLibrary("static/setting.js");
          });
}
...
function appendLibrary(i) {
    (e = document.createElement("script")), (e.defer = !0), (e.type = "application/javascript"), (e.src = i), document.getElementsByTagName("head")[0].appendChild(e);
}
var isMobile = {
    Android: function () {
