function updateData() {
    $.ajax({ url: "/updateData" }).done(function (t) {
        ...
        $("#U1").text(t.U1), $("#U2").text(t.U2), $("#U3").text(t.U3);
        $("#I1").text(rnd(t.I1,100,2,true)),
        $("#I2").text(rnd(t.I2,100,2,true)),
        $("#I3").text(rnd(t.I3,100,2,true)),
        $("#P1").text(rnd(t.P1,1e3,2,true)),
        $("#P2").text(rnd(t.P2,1e3,2,true)),
        $("#P3").text(rnd(t.P3,1e3,2,true)),
        ...
        $("#PF1").text(rnd(t.PF1,100,2)),
        $("#PF2").text(rnd(t.PF2,100,2)),
        $("#PF3").text(rnd(t.PF3,100,2)),
        $("#PP1p").text(rnd(t.PP1p,1e3,1)),
        $("#PP2p").text(rnd(t.PP2p,1e3,1)),
        $("#PP3p").text(rnd(t.PP3p,1e3,1)),
        $("#PN1p").text(rnd(t.PN1p,1e3,1)),
        $("#PN2p").text(rnd(t.PN2p,1e3,1)),
        $("#PN3p").text(rnd(t.PN3p,1e3,1)),
        $("#E1dP").text(rnd(t.E1dP,100,1)),
        $("#E2dP").text(rnd(t.E2dP,100,1)),
        $("#E3dP").text(rnd(t.E3dP,100,1)),
        $("#E1dN").text(rnd(t.E1dN,100,1)),
        $("#E2dN").text(rnd(t.E2dN,100,1)),
        $("#E3dN").text(rnd(t.E3dN,100,1)),

        t.E1tP / 100 > 1e6 || t.E2tP / 100 > 1e6 || t.E3tP / 100 > 1e6
            ? ($("#E1tP").text(rnd(t.E1tP,1e8,2)), $("#E2tP").text(rnd(t.E2tP,1e8,2)), $("#E3tP").text(rnd(t.E3tP,1e8,2)), $("#EtP").text("↓ Total E [GWh]"))
            : t.E1tP / 100 > 1e3 || t.E2tP / 100 > 1e3 || t.E3tP / 100 > 1e3
            ? ($("#E1tP").text(rnd(t.E1tP,1e5,2)), $("#E2tP").text(rnd(t.E2tP,1e5,2)), $("#E3tP").text(rnd(t.E3tP,1e5,2)), $("#EtP").text("↓ Total E [MWh]"))
            : ($("#E1tP").text(rnd(t.E1tP,100,1)), $("#E2tP").text(rnd(t.E2tP,100,1)), $("#E3tP").text(rnd(t.E3tP,100,1)), $("#EtP").text("↓ Total E [kWh]")),
        t.E1tN / 100 > 1e6 || t.E2tN / 100 > 1e6 || t.E3tN / 100 > 1e6
            ? ($("#E1tN").text(rnd(t.E1tN,1e8,2)),$("#E2tN").text(rnd(t.E2tN,1e8,2)), $("#E3tN").text(rnd(t.E3tN,1e8,2)), $("#EtN").text("↑ Total E [GWh]"))
            : t.E1tN / 100 > 1e3 || t.E2tN / 100 > 1e3 || t.E3tN / 100 > 1e3
            ? ($("#E1tN").text(rnd(t.E1tN,1e5,2)), $("#E2tN").text(rnd(t.E2tN,1e5,2)), $("#E3tN").text(rnd(t.E3tN,1e5,2)), $("#EtN").text("↑ Total E [MWh]"))
            : ($("#E1tN").text(rnd(t.E1tN,100,1)), $("#E2tN").text(rnd(t.E2tN,100,1)), $("#E3tN").text(rnd(t.E3tN,100,1)), $("#EtN").text("↑ Total E [kWh]")),
            
        $("#Current_EP").text(rnd(t.E1dP+t.E2dP+t.E3dP,100,2)),
        $("#Current_EN").text(rnd(t.E1dN+t.E2dN+t.E3dN,100,2)),
        $("#Previous_EP").text(rnd(t.EpDP,100,2)),
        $("#Previous_EN").text(rnd(t.EpDN,100,2)),
        $("#Total_EP").text(rnd(t.E1tP+t.E2tP+t.E3tP,100,0)),
        $("#Total_EN").text(rnd(t.E1tN+t.E2tN+t.E3tN,100,0)),
        $("#ID").text(t.ID),
...
function rnd(value,division,pos,signed){
    if(signed == true){
        return ((value > 32767 ? value - 65535 : value) / division).toFixed(pos)
    }else{
        return (value / division).toFixed(pos)
    }
}
        ...
        null != hourEnergyData[4 * n + 4]
            ? ((t = hourEnergyData[4 * n + 1]),
              ...
              1 == hourEnergyData[4 * n + 4]
                  ? (energyBarGraph.data.datasets[0].backgroundColor[24 - ((len - 1) / 4 - n)] = "#72BD00")
                  : (energyBarGraph.data.datasets[0].backgroundColor[24 - ((len - 1) / 4 - n)] = "#00BFEC"),
    ...
    $(function () {
        $("div.mainContainer").load("overview", function () {
                ...
                "overview" == $(this).attr("id")
                    ...
                    ? (clearTimeout(timer),
                      $("div.mainContainer").load("settings", function () {
                        $("#Lw").text("Preparing settings")
                        $(".loader").show()
                          var t = new Setting();
                          t.refreshSetting(), t.refreshWifiClient(), (evseInstanceGauge = "undefined"), $("#sideText").text("☰  Settings");
                      }))
            ...
            $(document).on("click", "#hourE", function () {
                selectedEnergy = 'hourly'
                energyBarGraph.clear()
                energyBarGraph.destroy()
                var t = new energyChart("", "Hourly E [Wh]", "Wh")
                o = $("#barEnergy"),o.height('75vh'), d = t.getConfig(24),energyBarGraph = new Chart(o, d)
                refreshEnergyChartHourly();
            });
            ...
            $(document).on("click", "#dayE", function () {
                ...
                energyBarGraph.clear()
                energyBarGraph.destroy()
                var t = new energyChart("", "Daily E [kWh]", "kWh")
                o = $("#barEnergy"),o.height('75vh'),d = t.getConfig(31),energyBarGraph = new Chart(o, d),
                refreshEnergyChartDaily();          
            });
            ...
            $(document).on("click", "#monthE", function () {
                ...
                energyBarGraph.clear()
                energyBarGraph.destroy()
                var t = new energyChart("", "Monthly E [kWh]", "kWh") 
                o = $("#barEnergy"),o.height('75vh'),d = t.getConfig(12),energyBarGraph = new Chart(o, d); 
                refreshEnergyChartMonthly();
            });
    });
