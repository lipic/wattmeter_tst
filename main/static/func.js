function updateData() {
    $.ajax({ url: "/updateData" }).done(function(t) {
        ...
        e -= 3600 * (E = Math.floor(e / 86400)) * 24;
        var a = Math.floor(e / 3600);
        e -= 3600 * a;
        var r = Math.floor(e / 60);
        (e -= 60 * r), $("#RUN_TIME").text((E < 10 ? "0" + E : E) + ":" + (a < 10 ? "0" + a : a) + ":" + (r < 10 ? "0" + r : r) + ":" + (e < 10 ? "0" + e : e));
        var n = t.U1,
            o = t.U2,
            d = t.U3;
        ...
        var i = ((t.I1 > 32767 ? t.I1 - 65535 : t.I1) / 100).toFixed(2),
            ...
            E = ((t.I3 > 32767 ? t.I3 - 65535 : t.I3) / 100).toFixed(2);
        $("#I1").text(i), $("#I2").text(l), $("#I3").text(E);
        var s = ((t.P1 > 32767 ? t.P1 - 65535 : t.P1) / 1e3).toFixed(2),
            u = ((t.P2 > 32767 ? t.P2 - 65535 : t.P2) / 1e3).toFixed(2),
            g = ((t.P3 > 32767 ? t.P3 - 65535 : t.P3) / 1e3).toFixed(2);
        $("#P1").text(s),
            $("#P2").text(u),
            $("#P3").text(g),
...
function handleEvseAPI(t, e, a, r) {
    for (var n = 1; n <= t; n++)
        ...
        2 == r[n - 1] ?
        ($("#EV_STATE" + n).text("PLUG"), chargingAnim("paused", n), $(".charge" + (1 + 4 * (n - 1))).css({ "background-color": "yellow" })) :
        3 == r[n - 1] && ($("#EV_STATE" + n).text("CHARGING"), chargingAnim("running", n), $(".charge" + (1 + 4 * (n - 1))).css({ "background-color": "green" }));
}

function dotControl() {
    elements = $(".dot");
    for (var t = 0; t < elements.length; t++) "red" == elements[t].style.backgroundColor ? (elements[t].style.backgroundColor = "") : (elements[t].style.backgroundColor = "red");
}
...
function refreshEnergyChartHourly() {
    ...
    for (var t = 0, e = 0, a = 0, r = 0, n = 0; n < 24; n++)
        ...
        ((t = hourEnergyData[4 * n + 1]),
            ...
            (a = a + dataP - dataN),
            (r += 1),
            (energyGraphHourly.data.labels[24 - ((len - 1) / 4 - n)] = t + 1 < 10 ? "0" + t + "-0" + (t + 1) : t + 1 == 10 ? "09-10" : t + "-" + (t + 1)),
            (energyGraphHourly.data.datasets[0].data[24 - ((len - 1) / 4 - n)] = dataP),
            1 == hourEnergyData[4 * n + 4] ?
            (energyGraphHourly.data.datasets[0].backgroundColor[24 - ((len - 1) / 4 - n)] = "rgb(114, 189, 0)") :
            (energyGraphHourly.data.datasets[0].backgroundColor[24 - ((len - 1) / 4 - n)] = "rgb(0, 191, 235)"),
            (energyGraphHourly.data.datasets[1].data[24 - ((len - 1) / 4 - n)] = -dataN)) :
        (t < 23 ?
            ((t += 1),
                (energyGraphHourly.data.labels[e] = t + 1 < 10 ? "0" + t + "-0" + (t + 1) : t + 1 == 10 ? "09-10" : t + "-" + (t + 1)),
                (energyGraphHourly.data.datasets[0].data[e] = 0),
                (energyGraphHourly.data.datasets[1].data[e] = 0),
                e++) :
            ((t = 0), (energyGraphHourly.data.labels[e] = "0" + t + "-0" + (t + 1)), (energyGraphHourly.data.datasets[0].data[e] = 0), (energyGraphHourly.data.datasets[1].data[e] = 0), e++),
            e > 23 && (e = 0));
    for (var o = 0; o < 24; o++) energyGraphHourly.data.datasets[2].data[o] = (a / r).toFixed(1);
...
function refreshEnergyChartDaily() {
    ...
    for (var a = 0; a < 31; a++)
        ...
        ((arr = dailyEnergyData[e - a].split(":")),
            ...
            (dataP = dat[0]),
            (dataN = dat[1]),
            (energyGraphDaily.data.labels[30 - a] = t),
            (energyGraphDaily.data.datasets[0].data[30 - a] = parseFloat(dataP / 100).toFixed(1)),
            (energyGraphDaily.data.datasets[1].data[30 - a] = -parseFloat(dataN / 100).toFixed(1))) :
        ((energyGraphDaily.data.labels[30 - a] = days[a]), (energyGraphDaily.data.datasets[0].data[30 - a] = 0), (energyGraphDaily.data.datasets[1].data[30 - a] = 0));
    for (var r = 0; r < 31; r++) energyGraphDaily.data.datasets[2].data[r] = getAvgEnergy();
    energyGraphDaily.update();
}

function getAvgEnergy() {
    for (var t = 0, e = 0, a = 0; a < 31; a++)
        null != dailyEnergyData && null != dailyEnergyData[a] && ((arr = dailyEnergyData[a].split(":")), (dat = JSON.parse(arr[1])), (dataP = dat[0]), (dataN = dat[1]), (t = t + parseFloat(dataP / 100) - parseFloat(dataN / 100)), e++);
            ...
            $("#powerTxt").text("0.0"),
                (timer = setInterval(function() {
                    $.ajax({ url: "/updateData" }).done(function(e) {
                        $("#updateData").html(e.datalayer), "undefined" == evseInstanceGauge && 0 != e.NUMBER_OF_EVSE && ((evseInstanceGauge = new evse(e.NUMBER_OF_EVSE)), evseInstanceGauge.createEvseGauge());
                        var a = (((e.P1 > 32767 ? e.P1 - 65535 : e.P1) + (e.P2 > 32767 ? e.P2 - 65535 : e.P2) + (e.P3 > 32767 ? e.P3 - 65535 : e.P3)) / 1e3).toFixed(1);
                        t.set((a > 20 ? 20 : a) < 0 ? -1 * (a > 20 ? 20 : a) : a > 20 ? 20 : a), $("#powerTxt").text(a.toString()), (powerAVGchartData = e.P_minuten), (hourEnergyData = e.E_hour), (dailyEnergyData = e.DailyEnergy);
                        for (var r = ((e.E1tP + e.E2tP + e.E3tP) / 100).toFixed(0).toString(), n = ((e.E1dP + e.E2dP + e.E3dP) / 100).toFixed(1).toString(), o = (e.EpDP / 100).toFixed(1).toString(), d = r.length - 1; d >= 0; d--)
                            $("#kWh" + (r.length - d)).text(r[d]), $("#dWh" + (n.length - d)).text(n[d]), $("#lWh" + (o.length - d)).text(o[d]);
                        handleEvseAPI(e.NUMBER_OF_EVSE, e.ACTUAL_CONFIG_CURRENT, e.ACTUAL_OUTPUT_CURRENT, e.EV_STATE), dotControl();
                    });
                }, 2e3));
        }),
            ...
            "overview" == $(this).attr("id") ?
                        ...
                        $("#powerTxt").text("0.0"),
                            (timer = setInterval(function() {
                                $.ajax({ url: "/updateData" }).done(function(e) {
                                    $("#updateData").html(e.datalayer), "undefined" == evseInstanceGauge && 0 != e.NUMBER_OF_EVSE && ((evseInstanceGauge = new evse(e.NUMBER_OF_EVSE)), evseInstanceGauge.createEvseGauge());
                                    var a = (((e.P1 > 32767 ? e.P1 - 65535 : e.P1) + (e.P2 > 32767 ? e.P2 - 65535 : e.P2) + (e.P3 > 32767 ? e.P3 - 65535 : e.P3)) / 1e3).toFixed(1);
                                    t.set((a > 20 ? 20 : a) < 0 ? -1 * (a > 20 ? 20 : a) : a > 20 ? 20 : a),
                                        $("#powerTxt").text(a.toString()),
                                        (powerAVGchartData = e.P_minuten),
                                        (hourEnergyData = e.E_hour),
                                        (dailyEnergyData = e.DailyEnergy);
                                    for (
                                        var r = ((e.E1tP + e.E2tP + e.E3tP) / 100).toFixed(0).toString(), n = ((e.E1dP + e.E2dP + e.E3dP) / 100).toFixed(1).toString(), o = (e.EpDP / 100).toFixed(1).toString(), d = r.length - 1; d >= 0; d--
                                    )
                                        $("#kWh" + (r.length - d)).text(r[d]), $("#dWh" + (n.length - d)).text(n[d]), $("#lWh" + (o.length - d)).text(o[d]);
                                    handleEvseAPI(e.NUMBER_OF_EVSE, e.ACTUAL_CONFIG_CURRENT, e.ACTUAL_OUTPUT_CURRENT, e.EV_STATE), dotControl();
                                });
                ...
                (clearTimeout(timer),
                    $("div.mainContainer").load("settings", function() {
                        (evseInstanceGauge = "undefined"), $("#sideText").text("☰  Settings"), $("#refreshSSID").append('<span class="spinner-border spinner-border-sm"></span>');
                        var t = new Setting();
                        t.refreshSetting(),
                        t.refreshWifiClient();
                    })) :
                ...
                (clearTimeout(timer),
                    $("div.mainContainer").load("powerChart", function() {
                        ...
                        (timer = setInterval(function() {
                            $.ajax({ url: "/updateData" }).done(function(t) {
                                $("#updateData").html(t.datalayer), (powerAVGchartData = t.P_minuten), dotControl();
                            });
                        }, 5e3)),
                        loadPowerChart();
                    })) :
                ...
                (clearTimeout(timer),
                    $("div.mainContainer").load("energyChart", function() {
                        (evseInstanceGauge = "undefined"), "undefined" != energyGraphHourly && (energyGraphHourly.destroy(), energyGraphDaily.destroy()), $("#sideText").text("☰  Energy charts");
                        var t = new energyChart("", "Hourly E [Wh]", "Wh"),
                            e = new energyChart("", "Daily E [kWh]", "kWh");
                        (d = new energyChart("", "Monthly E [kWh]", "kWh")), (o = $("#energyGraph_hourly")), (d = t.getConfig(24)), (energyGraphHourly = new Chart(o, d));
                        var a = $("#energyGraph_daily"),
                            r = e.getConfig(31);
                        (energyGraphDaily = new Chart(a, r)),
                        (timer = setInterval(function() {
                            $.ajax({ url: "/updateData" }).done(function(t) {
                                $("#updateData").html(t.datalayer), (hourEnergyData = t.E_hour), (dailyEnergyData = t.DailyEnergy), refreshEnergyChartHourly(), refreshEnergyChartDaily(), dotControl();
                            });
                        }, 2e4)),
                        (energyGraphDaily.getDatasetMeta(1).hidden = !0),
                        energyGraphDaily.update(),
                            (energyGraphHourly.getDatasetMeta(1).hidden = !0),
                            energyGraphHourly.update(),
