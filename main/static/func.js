...
function updateData() {
    $.ajax({ url: "/updateData" }).done(function(e) {
        ...
        e.AC_IN > 0 ?
            (($('#AC_IN').text("ON")), ($('#AC_IN').css("color", "#74DF00"))) :
            (($('#AC_IN').text("OFF")), ($('#AC_IN').css("color", "#FF0000"))),
            e.RELAY > 0 ?
            ...
            ($('#PP1p').text((e.PP1p / 1e3).toFixed(1))),
            ($('#PP2p').text((e.PP2p / 1e3).toFixed(1))),
            ($('#PP3p').text((e.PP3p / 1e3).toFixed(1))),
            ($('#PN1p').text((e.PN1p / 1e3).toFixed(1))),
            ($('#PN2p').text((e.PN2p / 1e3).toFixed(1))),
            ($('#PN3p').text((e.PN3p / 1e3).toFixed(1))),
            ...
            if(((e.E1tP / 100)>1000000)||((e.E2tP / 100)>1000000)||((e.E3tP / 100)>1000000)){
                ($('#E1tP').text((e.E1tP / 100000000).toFixed(2)),$('#E2tP').text((e.E2tP / 100000000).toFixed(2)),$('#E3tP').text((e.E3tP / 100000000).toFixed(2),$('#EtP').text("\u2191 Total E [GWh]")))
            }else if(((e.E1tP / 100)>1000)||((e.E2tP / 100)>1000)||((e.E3tP / 100)>1000)){
                ($('#E1tP').text((e.E1tP / 100000).toFixed(2)),$('#E2tP').text((e.E2tP / 100000).toFixed(2)),$('#E3tP').text((e.E3tP / 100000).toFixed(2),$('#EtP').text("\u2191 Total E [MWh]")))
            }else{
                ($('#E1tP').text((e.E1tP / 100).toFixed(2)),$('#E2tP').text((e.E2tP / 100).toFixed(2)),$('#E3tP').text((e.E3tP / 100).toFixed(2),$('#EtP').text("\u2191 Total E [kWh]")))
            }
            if(((e.E1tN / 100)>1000000)||((e.E2tN / 100)>1000000)||((e.E3tN / 100)>1000000)){
                ($('#E1tN').text((e.E1tP / 100000000).toFixed(2)),$('#E2tN').text((e.E2tN / 100000000).toFixed(2)),$('#E3tN').text((e.E3tN / 100000000).toFixed(2),$('#EtN').text("\u2191 Total E [GWh]")))
            }else if(((e.E1tN / 100)>1000)||((e.E2tN / 100)>1000)||((e.E3tN / 100)>1000)){
                ($('#E1tN').text((e.E1tN / 100000).toFixed(2)),$('#E2tN').text((e.E2tN / 100000).toFixed(2)),$('#E3tN').text((e.E3tN / 100000).toFixed(2),$('#EtN').text("\u2191 Total E [MWh]")))
            }else{
                ($('#E1tN').text((e.E1tN / 100).toFixed(2)),$('#E2tN').text((e.E2tN / 100).toFixed(2)),$('#E3tN').text((e.E3tN / 100).toFixed(2),$('#EtN').text("\u2191 Total E [kWh]")))
            }
    ...
    $("div.mainContainer").load("overview", function() {
            ...
            timer = setInterval(function() {
                $.ajax({ url: "/updateData" }).done(function(e) {
                    ...
                    var m = ((e.EpDP + e.EpDP + e.EpDP)/ 100).toFixed(1).toString()
                    for (var i = (k.length - 1); i >= 0; i--) {
                        $('#kWh' + (k.length - i)).text(k[i]);
                        $('#dWh' + (l.length - i)).text(l[i]);
                        $('#lWh' + (m.length - i)).text(m[i]);
                    }
